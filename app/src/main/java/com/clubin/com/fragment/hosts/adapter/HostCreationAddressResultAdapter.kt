...
class HostCreationAddressResultAdapter(val mContext: Context, val list: MutableList<String>) : RecyclerView.Adapter<HostCreationAddressResultAdapter.ViewHolder>() {
